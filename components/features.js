	...
	return (
		<section className={'bg-white dark:bg-gray-900'}>
			<div className={'container px-6 py-10 mx-auto'}>
				<h1 className={'text-3xl font-semibold text-center text-gray-800 capitalize lg:text-4xl dark:text-white'}>explore our <br></br> awesome <span className={'text-blue-500'}>Components</span></h1>
